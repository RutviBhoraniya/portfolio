        ...
        <section className='Projects container' id='project'>
            ...
            <div className='projects-row'>
                ...
                <div className='project'>
                    ...
                    <a href='https://github.com/RutviBhoraniya/Test-Your-IQ' target="_blank" rel="noopener noreferrer">
                        <h2 className='project-title'>Test your IQ</h2>
                    </a>
                ...
                <div className='project'>
                    ...
                    <a href='https://mathematical-puzzle.netlify.app/home/home' target="_blank" rel="noopener noreferrer">
                        <h2 className='project-title'>Mathematical Puzzle</h2>
                    </a>
                ...
                <div className='project'>
                    ...
                    <a href='https://weather-by-rrb.netlify.app/' target="_blank" rel="noopener noreferrer">
                ...
                <div className='project'>
                    ...
                    <a href='https://cultureatlasbydr.onrender.com/' target="_blank" rel="noopener noreferrer">
                        <h2 className='project-title'>Atlas</h2>
                    </a>
